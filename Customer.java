...
public class Customer
{
   ...
   * from user's input
   *
   * @param  lname  Last Name of a new Customer 
   * @param  phone2  Phone Number of a new Customer
   * @param  balance  current amount of money that a new Customer has owned
   * @param  custNumber  IdNumber of a new Customer
   * @return      
   */
   ...
   *
   * @param  amount  the amount of money that withdraw from the specific Customer account
   ...
   */
   public double withdraw(double amount)
   {
      ...
      { 
         JOptionPane.showMessageDialog(null, "Error: Withdrawl must be greater than 0 \nCustomer: "+this.getCustomerName()+"\nRequested: "+this.fmt.format(amount)+"\nAvailable: "+this.fmt.format(balance));
      }
      else if (amount > balance) // Withdrawal amount is larger than the balance
      {
   ...
   * <p>
   * This method is taking care of depositing money into Customer's Account, plus calculating the interest rate.
   *
   * @param  amount  the amount of money that withdraw from the specific Customer account
   ...
   * @param  balance: current amount of money that a Customer has owned
   * @return  void
   */
   ...
   * @param  phoneNumber: current Customer's Phone Number
   * @return  void
   */
   ...
   * @param  idNumber: current Customer's idNumber
   * @return  void
   */
  ...
  /**
   * Method for finding the index in Customer ArrayList
   * The method will return the index of the customer in the list, 
   * or return -1 if the customer is not in the array
   * 
   * @param  custsArray: Customer's ArrayList
   * @param  xnam: the particular index of a Customer
   * @param  count: total number of customers
  ...
  //ToString method, printing out all of the particular customer's attributes(name, balanc, phone, idnumber)
  
   public String toString ()
   {
      return (lname + "\t" + idNumber + "\t" + fmt.format(balance) +
               "\t" + phone);
   }
  
  
  /**
   * Method to sort the customer array in alphabetical order by name. Using the select sort.
   * 
   * @param  custsArray: Customer's ArrayList
   * @param  count: total number of customers
   * @return  void: 
  ...
  //addNewCustomer method that adds new customer into customers arraylist
   public void addNewCustomer(Customer[] custsArray, int count, String name, long custNumber, double balance2, String phone2) {
